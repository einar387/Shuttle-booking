...
class PassengersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create passenger" do
    assert_difference("Passenger.count") do
      post passengers_url, params: { passenger: { contact_number: @passenger.contact_number, email: @passenger.email, first_name: @passenger.first_name, last_name: @passenger.last_name, number_of_seat: @passenger.number_of_seat, service_id: @passenger.service_id } }
    end
  ...
  test "should update passenger" do
    patch passenger_url(@passenger), params: { passenger: { contact_number: @passenger.contact_number, email: @passenger.email, first_name: @passenger.first_name, last_name: @passenger.last_name, number_of_seat: @passenger.number_of_seat, service_id: @passenger.service_id } }
